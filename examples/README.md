...
After appliyng klib.data_cleaning() the size reduces by about 36 MB. This is achieved by dropping empty and single valued columns as well as empty and duplicate rows (None found in this example). Additionally, the optimal data types are inferred and applied.
